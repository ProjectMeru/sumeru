...
func renderAddonInit(workspaceModule, addonName string) string {
	return fmt.Sprintf("// Code generated by sumeru-import-gen; DO NOT EDIT.\n\npackage %s\n\nimport (\n\t_ \"%s/addons/%s/models\"\n)\n",
		addonName, workspaceModule, addonName)
}
